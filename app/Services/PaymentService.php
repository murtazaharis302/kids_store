    ...
    public static function getAvailableMethods(): array
    {
        return [
            'jazzcash' => [
                ...
                'icon' => 'smartphone',
                'account_title' => config('services.payment.jazzcash.title', 'Khizer hayat'),
            ...
            'easypaisa' => [
                ...
                'badge' => '⚡ 0% Fee • Instant Mobile Transfer',
                'icon' => 'wallet',
                'account_title' => config('services.payment.easypaisa.title', 'Khizer hayat'),
                'account_number' => config('services.payment.easypaisa.number', '03150132001'),
            ...
            'bank_transfer' => [
                'id' => 'bank_transfer',
                'name' => 'Askari Bank Transfer (IBFT)',
                'badge' => '⚡ 0% Fee • All Banking Apps Supported',
                'icon' => 'building-bank',
                'bank_name' => config('services.payment.bank.bank_name', 'Askari Commercial Bank'),
                'account_title' => config('services.payment.bank.title', 'Al hayat Garments'),
                'account_number' => config('services.payment.bank.account_number', '09450200002583'),
                'iban' => config('services.payment.bank.iban', 'PK00ASCB09450200002583'),
                'instructions' => 'Transfer via Askari Bank or any banking app using Account / IBAN details. Upload screenshot receipt below.',
            ],
            'card' => [
                'id' => 'card',
