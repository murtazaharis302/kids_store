        ...
        <div class="lg:col-span-8 space-y-6">
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-6">
                <div class="flex items-center justify-between border-b border-slate-100 pb-3">
                    <div>
                        ...
                        <p class="text-xs text-slate-500">Generate combinations automatically or add variants manually with custom pricing & stock.</p>
                    </div>
            ...
            <div class="bg-white p-6 rounded-2xl border border-slate-200/80 shadow-xs space-y-4">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <!-- Primary Cover Image -->
                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-slate-700">Primary Cover Image</label>
                    ...
                    <!-- Gallery Images -->
                    <div class="space-y-2">
                        <label class="block text-xs font-bold text-slate-700">Additional Gallery Images</label>
